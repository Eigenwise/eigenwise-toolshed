...
- Codegraph uses strict TypeScript with explicit graph model types, file-owned facts, normalized project-relative paths, and typed runtime acquisition boundaries.
