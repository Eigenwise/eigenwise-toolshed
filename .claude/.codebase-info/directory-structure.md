...
- `plugins/whittle/`: registered single-policy plugin with Claude lifecycle hooks, canonical skill prose and a runtime test. No host exports, adapters, MCP server, mode preferences, switching commands or statusline.
