...
- `plugins/whittle/`: registered single-policy plugin with Claude lifecycle hooks, canonical skill prose, generated static instruction exports, OpenCode/Pi/Hermes adapters, a read-only MCP server, and core/export/stdio tests. No mode preferences, switching commands or statusline remain.
