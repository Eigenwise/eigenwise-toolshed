...
const MODEL_PRICES_PER_MILLION = {
  ...
  'claude-codex-gpt-5.6-fable': { input: 2.5, cacheRead: 0.25, cacheCreation: 2.5, output: 15 },
  'claude-codex-gpt-5.6-sol': { input: 2.5, cacheRead: 0.25, cacheCreation: 2.5, output: 15 },
...
function unpricedModelsExpression(bucket = '$bucket') {
  const models = Object.keys(MODEL_PRICES_PER_MILLION).join('|');
