...
const EVENT_ATTRIBUTES = Object.freeze({
  ...
  'claude_code.mcp_server_connection': ['mcp_server', 'status', 'error_type', 'error_code'],
  'claude_code.hook_execution_start': ['hook_name', 'status'],
  'claude_code.hook_execution_complete': ['hook_name', 'status', 'error_type', 'error_code'],
