...
2. Run it from anywhere inside the repository; it resolves the repository root itself:
   ...
   by Workbench hooks. Session-hosting subdirectories are found by encoding each real subdirectory the way
