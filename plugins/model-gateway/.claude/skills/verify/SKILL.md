...
4. `env --write-user` against a temporary HOME to check wiring and preservation of user-set values. Wiring is global only; `--write-project`, `--mode`, and `--show-mode` are retired and must exit 2.
