#!/usr/bin/env node
// Regenerates the five switchboard-exec-<effort>.md agent files from the single
// source template plugins/switchboard/scripts/_exec-template.md.
//
// Usage: node plugins/switchboard/scripts/gen-exec-agents.js
//
...
function main() {
  ...
  for (const effort of EFFORTS) {
    ...
    const outPath = path.join(AGENTS_DIR, `switchboard-exec-${effort}.md`);
