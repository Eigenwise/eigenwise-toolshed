...
const DEFAULT_GLOBAL_FALLBACK = null;
const HARD_DEFAULT_ROUTE = Object.freeze({ model: 'sonnet', effort: 'high' });

module.exports = { DEFAULT_CATEGORIES, DEFAULT_GLOBAL_FALLBACK, HARD_DEFAULT_ROUTE };
