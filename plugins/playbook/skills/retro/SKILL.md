...
needs the transcripts on disk, which is the `skill-retro` skill in this same plugin. Hand off to it
rather than guessing at sessions you cannot see; come back here for friction only this session's
context can show.
