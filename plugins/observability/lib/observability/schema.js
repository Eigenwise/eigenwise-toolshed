...
const ALLOWED_MEASUREMENTS = Object.freeze([
  ...
  'context_tokens',
  'input_tools_tokens',
  'input_native_tools_tokens',
  'input_mcp_tools_tokens',
  'input_system_tokens',
  'input_first_message_tokens',
  'input_history_tokens',
  'input_tool_results_tokens',
  'cache_read_tools_tokens',
  'cache_read_system_tokens',
  'cache_read_first_message_tokens',
  'cache_read_history_tokens',
  'fresh_tools_tokens',
  'fresh_system_tokens',
  'fresh_first_message_tokens',
  'fresh_history_tokens',
  ...
  'tool_result_tokens',
  'assistant_turns',
  'recharge_weighted_tool_result_bytes',
  'duration_ms',
  'active_time_ms',
  'blocked_ms',
  'api_duration_ms',
  ...
  'input_system_bytes',
  'input_tools_bytes',
  'input_native_tools_bytes',
  'input_mcp_tools_bytes',
  'input_messages_bytes',
  'input_first_message_bytes',
  'input_history_bytes',
  'input_tool_results_bytes',
  'request_count',
  'tool_count',
  ...
  'rate_limit_input_tokens_limit',
  'rate_limit_input_tokens_remaining',
  'rate_limit_input_tokens_reset_at_ms',
  'rate_limit_output_tokens_limit',
  'rate_limit_output_tokens_remaining',
  'rate_limit_output_tokens_reset_at_ms',
  'rate_limit_tokens_limit',
  'rate_limit_tokens_remaining',
  'rate_limit_tokens_reset_at_ms',
  'retry_after_ms',
  'codex_throttle_used_percent',
  'rate_limit_percent',
  'rate_limit_reset_ms',
  'rate_limit_five_hour_used_percent',
  'rate_limit_five_hour_reset_at_ms',
  'rate_limit_seven_day_used_percent',
  'rate_limit_seven_day_reset_at_ms',
  'dropped_records',
  'queue_depth',
  'queue_capacity',
]);
...
const ATTRIBUTE_SPECS = Object.freeze({
  ...
  status: 'status',
  status_code: 'nonnegative_integer',
  stop_reason: 'identifier',
  task_status: 'status',
  token_estimator: 'identifier',
...
const EVENT_ATTRIBUTES = Object.freeze({
  ...
  'claude_code.tool_result': ['tool_name', 'tool_kind', 'is_mcp', 'mcp_server', 'mcp_tool', 'plugin_name', 'status', 'error_type', 'error_code'],
  'claude_code.tool_decision': ['tool_name', 'tool_kind', 'is_mcp', 'mcp_server', 'mcp_tool', 'plugin_name', 'decision'],
  'claude_code.mcp_server_connection': ['mcp_server', 'plugin_name', 'status', 'error_type', 'error_code'],
  'claude_code.hook_execution_start': ['hook_name', 'hook_event', 'mcp_server', 'plugin_name', 'status'],
  'claude_code.hook_execution_complete': ['hook_name', 'hook_event', 'mcp_server', 'plugin_name', 'status', 'error_type', 'error_code'],
  ...
  'hook.task_completed': ['project_name', 'task_status'],
  ...
  'codex_gateway.route': [
    ...
    'fallback', 'via', 'status', 'status_code', 'trace_linked', 'path_class', 'error_type', 'error_code',
  ],
  'gateway.token.usage': [
  ...
  'workbench.recharge_rollup': ['project_name', 'tool_name'],
