...
/**
 * SessionStart: decide whether a retrospective is worth suggesting, and say so in one line if it
 ...
 * waits until the user opts in by running the retro skill.
 */
...
function main() {
  ...
  if (!state.sessions.length && !state.lastRetroAt) {
