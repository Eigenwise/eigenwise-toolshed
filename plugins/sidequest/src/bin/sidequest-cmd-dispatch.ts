  ...
  if (!result.ok) {
    const message = result.reason === 'not_found'
      ...
      : result.reason === 'stale'
        ...
        : 'dispatch token was refused, likely because it was transcribed incorrectly. Re-read the grouped lowercase token from this executor prompt and retry; do not re-run dispatch.';
