  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        verify: { type: 'string', maxLength: 4000, description: 'Typed evidence required only for active commandless working-tree delivery. Command or suite delivery still requires its matching verify-capture.' },
        session: { type: 'string' },
      },
