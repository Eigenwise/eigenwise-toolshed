export const ROUTING_PROFILE_SEED_REVISION = 7;
...
export const STARTER_ROUTING_PROFILES = [
  {
    id: 'coding',
    name: 'Coding',
...
const GATEWAY_ROUTE_BY_PROFILE_CATEGORY: Readonly<Record<string, Readonly<Record<string, { model: string; effort: string }>>>> = {
  coding: {
