...
function bindDispatchAgent(sessionId?: any, executor?: any, agentId?: any, agentName?: any, worktree?: any) {
  ...
  for (const match of matches) {
    const worktreeFacts = match.sharedTree === false && normalizedWorktree
