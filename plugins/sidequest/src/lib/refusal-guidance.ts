...
export const CLAIM_REFUSAL_MESSAGES: Readonly<Record<string, RefusalMessage>> = Object.freeze({
  ...
  unbound_dispatch: (ref) => `${ref} is an isolated dispatch without a bound harness agent identity. Do not claim its token manually. Re-run dispatch and pass the returned spawn unchanged to Agent.`,
