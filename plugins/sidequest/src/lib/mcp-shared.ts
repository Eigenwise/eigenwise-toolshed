...
const TOOL_DESCRIPTION_OVERRIDES: Record<string, string> = {
  ...
  integrate: 'Deliver ref/wave; pinned deliveryMethod supported.',
  ...
  release: 'Release claim; reason required. oracle handoff needs ask, then awaiting-oracle until verdict.',
  groomClose: 'Close: deliveryCommit reachable or pinned reset/working-tree/manual deliveryMethod.',
