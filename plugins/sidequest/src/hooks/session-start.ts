...
function main(): void {
  ...
  emit(
    '=== sidequest (active) ===\n' +
      ...
      'Atomic = one change, investigation, spike, or review one agent checks. Split for parallelism; keep coupled work together. ' +
      'Specs need anchors, contract, bounds/non-goals, dependencies/decisions, and verify, or artifact/answer. several deliverables on one ticket is a smell: use a ticketed planning investigation that pins the shared contract, a wave fanning the pieces out. An external tracker such as Jira still uses Sidequest locally.\n' +
      'Execution economy:\n' +
