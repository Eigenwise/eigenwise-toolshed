...
test('done reads --body-file into its closing comment before completing', () => {
  ...
  cliJson(['claim', ref, '--by', 'body-file-worker', '--direct', '--reason', 'The body-file fixture needs an inline claim.', '--json']);
...
test('done retry after a lost response returns the existing completion without duplicating its comment', () => {
  ...
  cliJson(['claim', ref, '--by', by, '--direct', '--reason', 'The body-file fixture needs an inline claim.', '--json']);
