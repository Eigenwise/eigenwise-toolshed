...
<style>
  .toolbar { display: flex; align-items: end; justify-content: space-between; gap: 1rem; margin-bottom: 1.5rem; } .title h1, .title p { margin: 0; } .title h1 { font-family: var(--font-serif); font-size: clamp(1.45rem, 2.5vw, 2rem); letter-spacing: -.03em; } .title p { margin-top: .25rem; color: var(--text-muted); font-size: .8rem; }
