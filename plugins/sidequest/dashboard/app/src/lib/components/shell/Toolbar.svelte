...
<style>
  ...
  .controls { display: flex; align-items: center; justify-content: end; gap: .4rem; flex-wrap: wrap; } button, input { font: inherit; } .controls > button, .controls > .menu-wrap > button, .controls .search input, .controls .priority { box-sizing: border-box; height: var(--control-height); min-height: var(--control-height); } button { border: 1px solid var(--border); border-radius: var(--radius); padding: .46rem .6rem; background: var(--surface); color: inherit; cursor: pointer; font-size: .76rem; } button:hover, button.active { border-color: var(--accent); background: var(--accent-soft); color: var(--accent); } .search span { position: absolute; width: 1px; height: 1px; overflow: hidden; clip: rect(0 0 0 0); } input { min-width: 12rem; padding: .46rem .65rem; border: 1px solid var(--border); border-radius: var(--radius); background: var(--surface); color: var(--text); }
  .priority { display: flex; overflow: hidden; border: 1px solid var(--border); border-radius: var(--radius); } .priority button { height: 100%; min-height: 0; border: 0; border-radius: 0; padding: 0 .6rem; text-transform: capitalize; } .priority button + button { border-left: 1px solid var(--border); } .menu-wrap { position: relative; } .popover { position: absolute; z-index: 3; top: calc(100% + .35rem); right: 0; display: grid; min-width: 13rem; padding: .25rem; border: 1px solid var(--border-strong); border-radius: var(--radius); background: var(--bg-deep); } .popover button { display: flex; align-items: center; justify-content: space-between; gap: 1rem; border: 0; text-align: left; } .popover small { color: var(--text-muted); } .popover i { width: .55rem; height: .55rem; border-radius: 999px; } .new-ticket { border-color: var(--accent); background: var(--accent); color: var(--text-on-accent); font-weight: 700; } .new-ticket:hover { background: var(--accent-strong); color: var(--text-on-accent); }
