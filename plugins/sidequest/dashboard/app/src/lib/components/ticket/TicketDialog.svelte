...
<style>
	.dialog-content { display:grid; grid-template-rows:auto minmax(0, 1fr) auto; min-block-size:0; max-block-size:inherit; overflow:hidden; } .dialog-header { display:flex; justify-content:space-between; gap:1rem; align-items:start; padding:1.25rem; border-bottom:1px solid var(--border); } h2 { margin:0; font-family:var(--font-serif); font-size:1.25rem; line-height:1.1; } small { color:var(--text-muted); } .main-grid { display:grid; grid-template-columns:minmax(0, 1.25fr) minmax(19rem, .75fr); gap:1.5rem; min-block-size:0; overflow:auto; margin:0; padding:1.25rem; scrollbar-width:thin; scrollbar-color:var(--border-strong) transparent; } .fields { display:grid; gap:.8rem; min-width:0; } label { display:grid; gap:.3rem; } input, textarea { box-sizing:border-box; width:100%; padding:.55rem; border:1px solid var(--border); border-radius:var(--radius); background:var(--surface-muted); color:var(--text); } textarea { min-height:10rem; resize:vertical; } .description { min-height:6rem; padding:.6rem; border:1px solid var(--border); border-radius:var(--radius); text-align:left; color:var(--text); background:var(--surface-muted); } .description span { color:var(--text-muted); } .three { display:grid; grid-template-columns:repeat(3, 1fr); gap:.5rem; } .check { display:flex; align-items:center; gap:.5rem; } .check input { width:auto; } aside { display:grid; align-content:start; gap:.8rem; min-width:0; } aside :global(section) { padding:.8rem; border:1px solid var(--border); border-radius:var(--radius); background:var(--surface-muted); } footer { display:flex; justify-content:end; gap:.5rem; margin:0; padding:1.25rem; border-top:1px solid var(--border); background:var(--surface-card); } footer.editor-actions { justify-content:space-between; } .markdown :global(p) { margin:.3rem 0; } @media (max-width:720px) { .main-grid, .three { grid-template-columns:1fr; } }
</style>
