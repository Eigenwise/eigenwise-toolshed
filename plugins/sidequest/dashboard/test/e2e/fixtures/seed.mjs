...
const doing = store.createTicket(first.slug, { title: 'Investigate stale agent claim', description: 'A blocked implementation.', priority: 'high', category: 'general', assignee: 'agent', source: 'cli' });
...
db.putRow(database, 'tickets', { id: current.id, project: first.slug, ref: current.ref, status: current.status, archived: current.archived ? 1 : 0, ord: current.order, claim_by: null, data: current });
