...
description: >-
  ...
  name sidequest-exec-high-<ticket> + model sonnet runs the ticket on sonnet at high effort.
  ...
  unique name when you spawn it (lowercase-hyphens, e.g. sidequest-exec-high-<ticket>), never an
