...
description: >-
  ...
  name sidequest-exec-medium-<ticket> + model sonnet runs the ticket on sonnet at medium effort.
  ...
  unique name when you spawn it (lowercase-hyphens, e.g. sidequest-exec-medium-<ticket>), never an
