...
description: >-
  ...
  model sonnet runs the ticket on sonnet at low effort. Pass the ticket ref, the sidequest CLI
...
4. **Close**: `sidequest done <ref> --by <same-worker-id> --model <your tier> --effort low --project <project>`
