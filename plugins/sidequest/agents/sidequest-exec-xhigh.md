...
description: >-
  ...
  name sidequest-exec-xhigh-<ticket> + model sonnet runs the ticket on sonnet at xhigh effort.
  ...
  unique name when you spawn it (lowercase-hyphens, e.g. sidequest-exec-xhigh-<ticket>), never an
