...
const TOOL_DESCRIPTION_OVERRIDES = {
  ...
  release: "Release claim; reason is required. Oracle needs an ask, then exits awaiting-oracle; oracle handoff stays until verdict.",
  groomClose: "Close a submission: deliveryCommit closes it as a delivery, integration:true as an integration, neither as grooming; each gate differs.",
