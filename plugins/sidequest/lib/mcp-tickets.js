...
function deferredVerificationAmendment(ticket) {
  const dispatch = ticket.dispatch;
  const pinnedRequirement = ticket.lifecycleAttempt?.verificationRequirement || dispatch?.lifecycleAttempt?.verificationRequirement || dispatch?.verificationRequirement;
...
const tools = [
  ...
  },
  {
    ...
    handler(args) {
      ...
      const verificationAmendment = verificationWasAmended ? deferredVerificationAmendment(t) : null;
