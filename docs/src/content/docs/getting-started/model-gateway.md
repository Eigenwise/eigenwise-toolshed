...
There are no routine Model Gateway commands to remember. The plugin keeps its local processes running, and Claude handles setup, updates, authentication checks, model discovery, and settings repair through the skill.
