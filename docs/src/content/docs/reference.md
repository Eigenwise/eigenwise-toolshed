...
This section is generated from the plugin manifests, skills, hooks, binaries, and marketplace metadata. The pages are rebuilt from the repository whenever the docs build runs. It currently covers all six plugins in the marketplace.
...
- [Skill Retro](./reference/skill-retro/) mines transcripts for repeated work and durable fixes.
